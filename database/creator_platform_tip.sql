...
CREATE TABLE `tip` (
  ...
  PRIMARY KEY (`id`),
  KEY `Tip_fanId_fkey` (`fanId`),
  KEY `Tip_creatorId_fkey` (`creatorId`),
...
INSERT INTO `tip` VALUES (1,3,1,10,'Great content!','2026-03-11 22:52:38.000'),(2,4,1,5,'Keep going!','2026-03-11 22:52:38.000');
